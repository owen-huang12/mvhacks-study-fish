(function () {
  chrome.storage.local.get("blockedSites", function (result) {
    ...
    var blocked = sites.some(function (site) {
      var s = site.replace(/^www\./, "").toLowerCase();
    ...
    var quip = "you have gone off the deep end.";

    var bgUrl = chrome.runtime.getURL("background.png");
    var fontUrl = chrome.runtime.getURL("LowresPixel-Regular.otf");
...
<body>
<div class="abyss-box">
  <div class="label">${site} is blocked</div>
  <div class="title">you are<br>in the abyss</div>
  <div class="divider"></div>
  <div class="quip">404: ${quip}</div>
